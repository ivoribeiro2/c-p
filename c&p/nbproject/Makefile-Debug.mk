...
${OBJECTDIR}/ingrediente.o: ingrediente.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ingrediente.o ingrediente.c

${OBJECTDIR}/linha_encomenda.o: linha_encomenda.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linha_encomenda.o linha_encomenda.c

${OBJECTDIR}/linha_produto_final.o: linha_produto_final.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linha_produto_final.o linha_produto_final.c
...
${OBJECTDIR}/producao.o: producao.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/producao.o producao.c

${OBJECTDIR}/produtoFinal.o: produtoFinal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/produtoFinal.o produtoFinal.c
...
${OBJECTDIR}/unidade.o: unidade.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/unidade.o unidade.c
